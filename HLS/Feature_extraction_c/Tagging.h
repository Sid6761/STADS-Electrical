    ...
    // Indices corresponding to tag and final_tag are tag-1 and final_tag-1 
...
void tagging(int arr_img_in[length][breadth],double arr_sums_x[200],double arr_sums_y[200],double arr_sums_weight[200],int arr_num_pixels[200],int arr_flags[200],int arr_final_tags[100][50])
{
