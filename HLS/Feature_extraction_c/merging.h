...
//update star coordinates
 arr_star_coordinates[final_tag_num+num_single_tag_stars-1][1]= -1*(((arr_sums_y[i_single_tag]/arr_sums_weight[i_single_tag])-1)-((length/2)-0.5));
arr_star_coordinates[final_tag_num+num_single_tag_stars-1][0]= (((arr_sums_x[i_single_tag]/arr_sums_weight[i_single_tag])-1)-((breadth/2)-0.5));
...
//update no. of stars
  ...
  //update star coordinates
  arr_star_coordinates[i_multi_tag][1]=-1*(((arr_tot_sum_y[i_multi_tag]/arr_tot_weights[i_multi_tag])-1)-((length/2)-0.5));
  arr_star_coordinates[i_multi_tag][0]=(((arr_tot_sum_x[i_multi_tag]/arr_tot_weights[i_multi_tag])-1)-((breadth/2)-0.5));
